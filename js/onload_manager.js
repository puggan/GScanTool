...
{
	//
	var dynamic_js = document.createElement('script'); dynamic_js.type = 'text/javascript'; dynamic_js.async = true;
	
	//
	dynamic_js.src = ('https:' == document.location.protocol ? 'https://www' : 'http://beta') + '.interfaceways.se/src/js/js_dynamic.php?v=20130131';
	
	//
	var s = document.getElementsByTagName('script')[0];
	
	//
	s.parentNode.insertBefore(dynamic_js, s);
}